    ...
    public:
        ...
        class ContactPoint {
            ...
            private:
                ...
                const rp3d::ContactPoint& mContactPoint;

                // -------------------- Methods -------------------- //

                /// Constructor
                ContactPoint(const rp3d::ContactPoint& contactPoint);
        ...
        class ContactPair {
            ...
            private:
                ...
                const rp3d::ContactPair& mContactPair;

                /// Pointer to the contact points
                Array<rp3d::ContactPoint>* mContactPoints;
                ...
                /// Constructor
                ContactPair(const rp3d::ContactPair& contactPair, Array<rp3d::ContactPoint>* contactPoints,
        ...
        class CallbackData {
            ...
            private:
                ...
                Array<rp3d::ContactPair>* mContactPairs;
                ...
                Array<rp3d::ContactPair>& mLostContactPairs;
                ...
                /// Constructor
                CallbackData(Array<rp3d::ContactPair>* contactPairs, Array<ContactManifold>* manifolds,
                             Array<rp3d::ContactPoint>* contactPoints, Array<rp3d::ContactPair>& lostContactPairs,
                             PhysicsWorld& world);
