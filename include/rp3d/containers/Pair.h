...
namespace std {
  ...
  template <typename T1, typename T2> struct hash<rp3d::Pair<T1, T2>> {

    size_t operator()(const rp3d::Pair<T1, T2>& pair) const {

        std::size_t seed = 0;
        rp3d::hash_combine<T1>(seed, pair.first);
        rp3d::hash_combine<T2>(seed, pair.second);
