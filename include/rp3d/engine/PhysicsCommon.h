...
#define RP3D_LOG(physicsWorldName, level, category, message, filename, lineNumber) if (rp3d::PhysicsCommon::getLogger() != nullptr) PhysicsCommon::getLogger()->log(level, physicsWorldName, category, message, filename, lineNumber)
