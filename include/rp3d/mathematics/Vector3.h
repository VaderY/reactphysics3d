...
#include <rp3d/mathematics/mathematics_common.h>
...
RP3D_FORCE_INLINE bool Vector3::approxEqual(const Vector3& vec1, const Vector3& vec2, decimal epsilon) {
    return rp3d::approxEqual(vec1.x, vec2.x, epsilon) && rp3d::approxEqual(vec1.y, vec2.y, epsilon) &&
           rp3d::approxEqual(vec1.z, vec2.z, epsilon);
}
