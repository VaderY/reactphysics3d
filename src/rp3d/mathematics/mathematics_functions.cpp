...
bool rp3d::approxEqual(const Vector3& vec1, const Vector3& vec2, decimal epsilon) {
    return approxEqual(vec1.x, vec2.x, epsilon) && approxEqual(vec1.y, vec2.y, epsilon) &&
           approxEqual(vec1.z, vec2.z, epsilon);
}

// Function to test if two vectors are (almost) equal
bool rp3d::approxEqual(const Vector2& vec1, const Vector2& vec2, decimal epsilon) {
    return approxEqual(vec1.x, vec2.x, epsilon) && approxEqual(vec1.y, vec2.y, epsilon);
}
...
// Christer Ericson.
void rp3d::computeBarycentricCoordinatesInTriangle(const Vector3& a, const Vector3& b, const Vector3& c,
...
Vector3 rp3d::clamp(const Vector3& vector, decimal maxLength) {
...
bool rp3d::areParallelVectors(const Vector3& vector1, const Vector3& vector2) {
    return vector1.cross(vector2).lengthSquare() < decimal(0.00001);
}

// Return true if two vectors are orthogonal
bool rp3d::areOrthogonalVectors(const Vector3& vector1, const Vector3& vector2) {
...
Vector3 rp3d::computeClosestPointOnSegment(const Vector3& segPointA, const Vector3& segPointB, const Vector3& pointC) {
...
void rp3d::computeClosestPointBetweenTwoSegments(const Vector3& seg1PointA, const Vector3& seg1PointB,
...
decimal rp3d::computePlaneSegmentIntersection(const Vector3& segA, const Vector3& segB, const decimal planeD, const Vector3& planeNormal) {
...
decimal rp3d::computePointToLineDistance(const Vector3& linePointA, const Vector3& linePointB, const Vector3& point) {
...
List<Vector3> rp3d::clipSegmentWithPlanes(const Vector3& segA, const Vector3& segB,
...
// This method implements the Sutherland–Hodgman clipping algorithm
List<Vector3> rp3d::clipPolygonWithPlanes(const List<Vector3>& polygonVertices, const List<Vector3>& planesPoints,
...
Vector3 rp3d::projectPointOntoPlane(const Vector3& point, const Vector3& unitPlaneNormal, const Vector3& planePoint) {
...
decimal rp3d::computePointToPlaneDistance(const Vector3& point, const Vector3& planeNormal, const Vector3& planePoint) {
    return planeNormal.dot(point - planePoint);
}

// Return true if the given number is prime
bool rp3d::isPrimeNumber(int number) {
...
uint64 rp3d::pairNumbers(uint32 number1, uint32 number2) {
