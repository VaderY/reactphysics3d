...
// Constructor
CollisionCallback::CallbackData::CallbackData(List<rp3d::ContactPair>* contactPairs, List<ContactManifold>* manifolds,
                                              List<rp3d::ContactPoint>* contactPoints, List<rp3d::ContactPair>& lostContactPairs, PhysicsWorld& world)
